	...
	PSTR szCmdLine, int iCmdShow)
{
	...
	HWND hwnd = CreateWindowEx(0, wndclass.lpszClassName, L"Game Window",
		style, windowRect.left, windowRect.top, windowRect.right - windowRect.left,
	...
	if (!gladLoadGL())
	{
		std::cout << "Cound not initialize GLAD \n";
	}
	else
	{
